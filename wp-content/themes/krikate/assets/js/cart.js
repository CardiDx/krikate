...
function addDeliveryDesc(item) {
    ...
    switch (value) {
        ...
        case 'free_shipping:4':
            delivery_description.innerHTML = 'Мы доставим Вашу покупку в любое отделение Белпочта . Стоимость доставки оплачивается по тарифам РУП «Белпочта» при получении. Совершая покупку на 400 бел.рублей и больше мы доставим ее до удобного для Вас отделения Белпочта бесплатно.';
            break;
        case 'flat_rate:8':
            delivery_description.innerHTML = 'Мы доставим покупку прямо к Вам домой или в офис. Стоимость доставки оплачивается по тарифам РУП «Белпочта» при получении. Совершая покупку на 700 бел.рублей и больше мы доставим ее до двери Бесплатно.';
            break;
        case 'flat_rate:9':
