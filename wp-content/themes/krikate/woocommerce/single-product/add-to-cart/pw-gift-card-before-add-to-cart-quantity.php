...
<div id="pwgc-purchase-container" data-min-amount="<?php echo apply_filters( 'pwgc_to_current_currency', $product->get_pwgc_custom_amount_min() ); ?>" data-max-amount="<?php echo apply_filters( 'pwgc_to_current_currency', $product->get_pwgc_custom_amount_max() ); ?>">
